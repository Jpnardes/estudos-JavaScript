...
let novo_paragrafo1 = document.createElement('p').textContent = 'Texto do novo paragrafo 1'
...
let novo_paragrafo2 = document.createElement('p').textContent = 'texto do novo paragrafo 2'
...
//Nesta abordagem, abordamos uma perspectiva geral de alguns métodos para o fazer